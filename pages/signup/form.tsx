...
export function SignupForm({
  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      try {
        ...
        const pendingEmail = AuthService.getPendingRegistrationEmail();
        if (pendingEmail) {
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Account created successfully! Welcome to Ink!");
      ...
      <form onSubmit={handleSignup} className="space-y-4">
        <FieldGroup>
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <h1 className="text-xl font-bold">Create your Ink account</h1>
            <FieldDescription>
